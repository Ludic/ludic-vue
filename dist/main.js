...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ludic__ = __webpack_require__(2);
...
/* harmony default export */ __webpack_exports__["default"] = {
  ...
  props: {
    ...
    app: { default: () => __WEBPACK_IMPORTED_MODULE_0_ludic__["LudicApp"] },
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (/******/function (modules) {
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__util_util__ = __webpack_require__(0);
      var _createClass = function () {
        function defineProperties(target, props) {
          for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__imageAssetLoader__ = __webpack_require__(23);
      var _createClass = function () {
        function defineProperties(target, props) {
          for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__asset__ = __webpack_require__(4);
      var _createClass = function () {
        function defineProperties(target, props) {
          for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_2__gamepadController__ = __webpack_require__(27);
      var _typeof = typeof Symbol === "function" && _typeof2(Symbol.iterator) === "symbol" ? function (obj) {
        return typeof obj === 'undefined' ? 'undefined' : _typeof2(obj);
      } : function (obj) {
        return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj === 'undefined' ? 'undefined' : _typeof2(obj);
      ...
      var InputController = function () {
        function InputController(canvas) {
          ...
          this.initKeys();
          this.initMouse();
          this.gpController = new __WEBPACK_IMPORTED_MODULE_2__gamepadController__["a" /* default */]();
          // this.initGamepads();
        }
        ...
        _createClass(InputController, [{
          ...
          value: function dispatchEvent(thisArg, handler, event) {
            ...
            for (var listener, i = listeners.length - 1; i >= 0; i--) {
              ...
              handler.call.apply(handler, [thisArg, listener, event].concat(args));
            }
          }
        }, {
          key: 'keyHandler',
      ...
      var importKeyConfig = function importKeyConfig(keyConfig) {
        ...
        var _loop = function _loop(_key5) {
          var mods = stripModifiers(_key5);
          var _key = _key5;
          var cfg = keyConfig[_key5];
          _key5 = __WEBPACK_IMPORTED_MODULE_1__keyCodeMap__["a" /* default */][mods.key] || mods.key;

          // everything needs to be an array of objects
          if (typeof cfg === 'string' || typeof cfg === 'function') {
            config[_key5] = [Object.assign({}, { method: cfg }, mods.config)];
          } else if ((typeof cfg === 'undefined' ? 'undefined' : _typeof(cfg)) === 'object' && !Array.isArray(cfg)) {
            config[_key5] = [Object.assign({}, mods.config, cfg)];
          } else if (Array.isArray(cfg)) {
            config[_key5] = cfg.map(function (conf) {
              return Object.assign({}, mods.config, conf);
            });
          } else {
            console.warn('InputController: Unsupported key config type \'' + (typeof cfg === 'undefined' ? 'undefined' : _typeof(cfg)) + '\' for \'' + _key5 + '\'', cfg);
          }
          key = _key5;
        };
          ...
          value: function _loadListener(listener) {
            ...
            try {
              for (var _iterator2 = avail[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                if (_key6 in listener) {
                  var method = listener[_key6];
                  ...
                  if (typeof method === 'function') {
                    ...
                    if (arr.length === 1) {
                      this[_key6] = arr[0].method;
                    } else {
                      console.warn('multiple entries per keycode is not supported at this yet.', _key6, arr, method);
                    }
                  }
                }
              }
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0_components_util_privateProperty__ = __webpack_require__(25);
      var _createClass = function () {
        function defineProperties(target, props) {
          for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__base_assetManager__ = __webpack_require__(5);
      var _typeof = typeof Symbol === "function" && _typeof2(Symbol.iterator) === "symbol" ? function (obj) {
        return typeof obj === 'undefined' ? 'undefined' : _typeof2(obj);
      } : function (obj) {
        return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj === 'undefined' ? 'undefined' : _typeof2(obj);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__HUDElement__ = __webpack_require__(3);
      var _createClass = function () {
        function defineProperties(target, props) {
          for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__canvas_canvas__ = __webpack_require__(2);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__BaseSprite__ = __webpack_require__(11);
      var _createClass = function () {
        function defineProperties(target, props) {
          for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__Dialog__ = __webpack_require__(12);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      "use strict";
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__imageAsset__ = __webpack_require__(7);
      var _createClass = function () {
        function defineProperties(target, props) {
          for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      __webpack_require__.d(exports, "LudicApp", function () {
        return __WEBPACK_IMPORTED_MODULE_2__components_app_LudicApp__["a"];
      });
      ...
      /* harmony reexport (binding) */__webpack_require__.d(exports, "default", function () {
        return __WEBPACK_IMPORTED_MODULE_3__components_app_ludic__["a"];
      });
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Ludic", function () {
        return __WEBPACK_IMPORTED_MODULE_3__components_app_ludic__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_4__components_base_asset__ = __webpack_require__(4);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Asset", function () {
        return __WEBPACK_IMPORTED_MODULE_4__components_base_asset__["a"];
      });
      /* harmony reexport (binding) */__webpack_require__.d(exports, "AssetManager", function () {
        return __WEBPACK_IMPORTED_MODULE_5__components_base_assetManager__["a"];
      });
      ...
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Camera", function () {
        return __WEBPACK_IMPORTED_MODULE_6__components_base_camera__["a"];
      });
      ...
      /* harmony reexport (default from non-hamory) */__webpack_require__.d(exports, "fps", function () {
        return __WEBPACK_IMPORTED_MODULE_7__components_base_fps___default.a;
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_8__components_base_imageAsset__ = __webpack_require__(7);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "ImageAsset", function () {
        return __WEBPACK_IMPORTED_MODULE_8__components_base_imageAsset__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_9__components_canvas_canvas__ = __webpack_require__(2);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Canvas", function () {
        return __WEBPACK_IMPORTED_MODULE_9__components_canvas_canvas__["a"];
      });
      /* harmony reexport (binding) */__webpack_require__.d(exports, "InputController", function () {
        return __WEBPACK_IMPORTED_MODULE_10__components_input_inputController__["a"];
      });
      ...
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Screen", function () {
        return __WEBPACK_IMPORTED_MODULE_11__components_screen_screen__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_12__components_screen_screenManager__ = __webpack_require__(10);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "ScreenManager", function () {
        return __WEBPACK_IMPORTED_MODULE_12__components_screen_screenManager__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_13__components_sprite_BaseSprite__ = __webpack_require__(11);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "BaseSprite", function () {
        return __WEBPACK_IMPORTED_MODULE_13__components_sprite_BaseSprite__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_14__components_sprite_MultiSprite__ = __webpack_require__(18);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "MultiSprite", function () {
        return __WEBPACK_IMPORTED_MODULE_14__components_sprite_MultiSprite__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_15__components_ui_Hud__ = __webpack_require__(19);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "HUD", function () {
        return __WEBPACK_IMPORTED_MODULE_15__components_ui_Hud__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_16__components_ui_HUDElement__ = __webpack_require__(3);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "HUDElement", function () {
        return __WEBPACK_IMPORTED_MODULE_16__components_ui_HUDElement__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_17__components_ui_Text__ = __webpack_require__(21);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Text", function () {
        return __WEBPACK_IMPORTED_MODULE_17__components_ui_Text__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_18__components_ui_Dialog__ = __webpack_require__(12);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Dialog", function () {
        return __WEBPACK_IMPORTED_MODULE_18__components_ui_Dialog__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_19__components_ui_MenuDialog__ = __webpack_require__(20);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "MenuDialog", function () {
        return __WEBPACK_IMPORTED_MODULE_19__components_ui_MenuDialog__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_20__components_util_util__ = __webpack_require__(0);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Util", function () {
        return __WEBPACK_IMPORTED_MODULE_20__components_util_util__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_21__components_util_utilities__ = __webpack_require__(22);
      /* harmony namespace reexport (by provided) */__webpack_require__.d(exports, "classTypeOf", function () {
        return __WEBPACK_IMPORTED_MODULE_21__components_util_utilities__["a"];
      });
      /* harmony import */var __WEBPACK_IMPORTED_MODULE_22__components_engine_Vector2__ = __webpack_require__(8);
      /* harmony reexport (binding) */__webpack_require__.d(exports, "Vector2", function () {
        return __WEBPACK_IMPORTED_MODULE_22__components_engine_Vector2__["a"];
      });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ludicAppComponent__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ludicAppComponent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_ludicAppComponent__);
...
var LudicVue = function () {
  function LudicVue() {
    _classCallCheck(this, LudicVue);
  }

  _createClass(LudicVue, null, [{
    key: 'install',
    value: function install(Vue) {
      Vue.component('ludic-app', __WEBPACK_IMPORTED_MODULE_0__components_ludicAppComponent___default.a);
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = LudicVue;
